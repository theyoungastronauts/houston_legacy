...
class FormProviderGenerator extends GeneratorForAnnotation<FormProviderGenAnnotation> {
  @override
  generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    ...
    final modelName = visitor.className.replaceAll("FormProvider", "");
    final className = "Houston$modelName";

    final source = File('../internal/generators/lib/src/templates/form_provider.mustache').readAsStringSync();
