...
class ListProviderGenerator extends GeneratorForAnnotation<ListProviderGenAnnotation> {
  @override
  generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    ...
    final modelName = visitor.className.replaceAll("ListProvider", "");
    final className = "Houston$modelName";

    final source = File('../internal/generators/lib/src/templates/list_provider.mustache').readAsStringSync();
