...
class ListScreenGenerator extends GeneratorForAnnotation<ListScreenGenAnnotation> {
  @override
  generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    ...
    final modelName = visitor.className.replaceAll("ListScreen", "");
    final className = "Houston$modelName";

    final source = File('../internal/generators/lib/src/templates/list_screen.mustache').readAsStringSync();
