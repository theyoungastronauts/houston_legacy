...
class ListTileGenerator extends GeneratorForAnnotation<ListTileGenAnnotation> {
  @override
  generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    ...
    final modelName = visitor.className.replaceAll("ListTile", "");
    final className = "Houston$modelName";

    final source = File('../internal/generators/lib/src/templates/list_tile.mustache').readAsStringSync();
