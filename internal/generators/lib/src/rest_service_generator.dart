...
class RestServiceGenerator extends GeneratorForAnnotation<RestServiceGenAnnotation> {
  @override
  generateForAnnotatedElement(Element element, ConstantReader annotation, BuildStep buildStep) async {
    ...
    final modelName = visitor.className.replaceAll("RestService", "");
    final className = "Houston$modelName";

    final source = File('../internal/generators/lib/src/templates/rest_service.mustache').readAsStringSync();
